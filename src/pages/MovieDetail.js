...
import { CircularProgress, Alert, Chip, IconButton, Button } from '@mui/material';
  ...
  useEffect(() => {
    const fetchMovieData = async () => {
      ...
      try {
        ...
        setVideos(movieData.videos?.results?.filter(v => v.type === 'Trailer' || v.type === 'Teaser').slice(0, 3) || []);
        ...
        <div className="detail-hero-content">
          ...
          <div className="detail-hero-info">
            <div className="detail-poster">
              <img 
                src={movie.poster_path ? `${IMG_POSTER_URL}${movie.poster_path}` : 'https://via.placeholder.com/500x750'} 
                alt={movie.title}
              />
            </div>
                ...
                <button
                  ...
                  onClick={() => {
                    if (isFav) {
                      ...
                      addToFavorites({ id: movie.id, title: movie.title, poster_path: movie.poster_path, type: 'movie' });
                      setIsFav(true);
                    }
                  }}
                >
